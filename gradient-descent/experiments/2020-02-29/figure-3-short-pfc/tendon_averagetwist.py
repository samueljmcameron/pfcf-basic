...
if __name__=="__main__":
    ...
    data_path = "../../2019-05-30/tendonpulling_stuff"
    ...
    for i,type in enumerate(types):
        ...
        obsfwd = ObservableData(["strain","averagetwist"],scan_dir=f'scanforward{type}',
                                scan=scan,loadsuf=loadsuf,loadfilepath=loadfilepath,
                                datfile=datfile,savesuf=savesuf)
    ...
    for observable in observable_list:
        ...
        if observable != "delta":
            ...
            ax[observable].set_xlabel(r"$\epsilon$",fontsize=10)#\times100\%$",fontsize = 10)
