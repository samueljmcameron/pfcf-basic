...
if __name__=="__main__":
    ...
    stresses = np.array([3.3708,18.539],float)
    strains_for["linear"] = np.array([0.00017323,0.00069291],float)
    strains_for["frustrated"] = np.array([0.0020157,0.0034803],float)
    ...
    for i,stress in enumerate(stresses):
        ...
        if (i > 0):
            ax.append(fig.add_subplot(2,1,i+1,sharex=ax[0]))
        else:
    ...
    fig.savefig(psi.psivsr_sname(name="psivsr_two_specific_stresses"))
